...
export function HealthEndpoint(checker: HealthChecker): (ctx: Context, next: () => void) => void {
...
export function LivenessEndpoint(checker: HealthChecker): (ctx: Context, next: () => void) => void {
    return async (ctx: Context, next: () => void) => {
...
export function ReadinessEndpoint(checker: HealthChecker): (ctx: Context, next: () => void) => void {
    return async (ctx: Context, next: () => void) => {
